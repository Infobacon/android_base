...
import com.usach.tbdgrupo7.iservifast.Controllers.MisServiciosSolicitadosGet;
...
public class MisServiciosSolicitados extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mis_servicios_solicitados);
        ...
        progressDialog = new ProgressDialog(MisServiciosSolicitados.this,R.style.AppTheme_Dark_Dialog);

        new MisServiciosSolicitadosGet(this).execute(getResources().getString(R.string.servidor) + "Solicitud/users/"+user.getIdUsuario());
        ...
        list.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Intent myIntent = new Intent(MisServiciosSolicitados.this, ServicioSolicitadoActivity.class);
        ...
        if (su.isNetworkAvailable()) {
            ...
            if(categorias!=null&&comunidades!=null){
                if (id == R.id.servicios_ofrecidos) {
                    Intent intent = new Intent(MisServiciosSolicitados.this, MainActivity.class);
                    ...
                    Intent intent = new Intent(MisServiciosSolicitados.this, ServiciosSolicitadosActivity.class);
                    intent.putExtra("categorias",categorias);
                    intent.putExtra("comunidades",comunidades);
                    intent.putExtra("usuario", user);
                    startActivity(intent);
                } else if (id == R.id.ofrecer_servicio){
                    Intent intent = new Intent(MisServiciosSolicitados.this,OfrecerActivity.class);
                    intent.putExtra("categorias",categorias);
                    intent.putExtra("comunidades",comunidades);
                    intent.putExtra("usuario",user);
                    startActivity(intent);
                    ...
                    Intent intent = new Intent(MisServiciosSolicitados.this,SolicitarActivity.class);
                    intent.putExtra("categorias",categorias);
                    intent.putExtra("comunidades",comunidades);
                    intent.putExtra("usuario",user);
                    startActivity(intent);
                ...
                Toast.makeText(MisServiciosSolicitados.this, "COMUNIDAD O CAT NULL", Toast.LENGTH_SHORT).show();
            }

        }else{
            Toast.makeText(MisServiciosSolicitados.this, "No se puede realizar la actividad solicitada, compruebe su conexión a internet.", Toast.LENGTH_SHORT).show();
        }
