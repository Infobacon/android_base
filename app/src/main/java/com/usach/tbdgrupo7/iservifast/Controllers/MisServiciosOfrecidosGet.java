 ...
 */
public class MisServiciosOfrecidosGet extends AsyncTask<String, Void, String> {
    ...
    public MisServiciosOfrecidosGet(MisServiciosOfrecidosActivity misServiciosOfrecidosActivity){
