...
import com.usach.tbdgrupo7.iservifast.Controllers.Posts.OfrecerPost;
...
public class OfrecerActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        progressDialog = new ProgressDialog(OfrecerActivity.this,R.style.AppTheme_Dark_Dialog);
    ...
    public void error_internet(){
        Toast.makeText(OfrecerActivity.this, getResources().getString(R.string.error_servidor), Toast.LENGTH_SHORT).show();
    }
